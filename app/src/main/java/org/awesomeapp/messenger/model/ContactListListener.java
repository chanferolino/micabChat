...
public interface ContactListListener {
    ...
    int LIST_LOADED = 3;
    int LIST_RENAMED = 4;
    int LIST_CONTACT_ADDED = 5;
    int LIST_CONTACT_REMOVED = 6;
    int CONTACT_BLOCKED = 7;
    int CONTACT_UNBLOCKED = 8;

    int ERROR_CREATING_LIST = -1;
    int ERROR_DELETING_LIST = -2;
    int ERROR_RENAMING_LIST = -3;

    int ERROR_LOADING_LIST = -4;
    int ERROR_LOADING_BLOCK_LIST = -5;

    int ERROR_RETRIEVING_PRESENCE = -6;

    int ERROR_ADDING_CONTACT = -7;
    int ERROR_REMOVING_CONTACT = -8;
    int ERROR_BLOCKING_CONTACT = -9;
    int ERROR_UNBLOCKING_CONTACT = -10;
     ...
     * @param contact
     */
    void onContactChange(int type, ContactList list, Contact contact);

    /**
     * Called when all the contact lists (including the block list) and contacts
     ...
     *            information.
     */
    void onContactsPresenceUpdate(Contact[] contacts);
     ...
     * @param contact
     */
    void onContactError(int errorType, ImErrorInfo error, String listName, Contact contact);
}
