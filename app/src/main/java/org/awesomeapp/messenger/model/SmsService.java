...
public interface SmsService {
    ...
    interface SmsListener {
         ...
         * @param data
         */
        void onIncomingSms(byte[] data);
    }

    /** Callback on send SMS failure. */
    interface SmsSendFailureCallback {
     ...
     */
    void sendSms(String dest, int port, byte[] data);
     ...
     *            be sent.
     */
    void sendSms(String dest, int port, byte[] data, SmsSendFailureCallback callback);
     ...
     */
    void removeSmsListener(SmsListener listener);
}
