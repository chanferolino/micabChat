...
public interface GroupMemberListener {
     ...
     */
    void onMemberJoined(ChatGroup group, Contact contact);
     ...
     */
    void onMemberLeft(ChatGroup group, Contact contact);
     ...
     */
    void onError(ChatGroup group, ImErrorInfo error);
     ...
     */
    void onSubjectChanged(ChatGroup group, String subject);
}
