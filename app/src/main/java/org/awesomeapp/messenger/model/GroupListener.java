...
public interface GroupListener {
    int ERROR_CREATING_GROUP = -1;
    int ERROR_DELETING_GROUP = -2;
    int ERROR_JOINING_IN_GROUP = -3;
    int ERROR_LEAVING_GROUP = -4;
     ...
     */
    void onGroupDeleted(ChatGroup group);
     ...
     */
    void onLeftGroup(ChatGroup group);
     ...
     */
    void onGroupError(int errorType, String groupName, ImErrorInfo error);
}
